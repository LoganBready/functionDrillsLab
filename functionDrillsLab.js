...
let nameGreeting = nameCheck('Logan') 
...
/*
  ...
  gold. Each chocolate frog costs 3 gold. Your function should take in a single parameter, which is the amount of gold you are willing to spend. 
  Your function should return a total amount of chocolate frogs you were able to purchase.
  Create a variable called `totalFrogs` and set it equal to your function invoked, passing in the amount of gold you are willing to spend.
*/

//CODE HERE
function frogBought(gold){
  return gold/3
  }
  let totalFrogs = frogBought(21)
...
/*
  ...
  However, you can't really go to a store and buy 1.333 products. You would just be able to purchase 1 product. 
...
let arrayIsAscending = ifAscending(sampleArray)
...
let bathtubScope = ["duck", "rubberduck", "sailordock"]
